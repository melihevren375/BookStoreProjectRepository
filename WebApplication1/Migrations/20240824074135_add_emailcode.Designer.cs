...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240824074135_add_emailcode")]
    partial class add_emailcode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concretes.EmailCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Concretes.EmailCode", b =>
                {
                    b.HasOne("Entities.Concretes.Customer", "Customer")
                        .WithOne("EmailCode")
                        .HasForeignKey("Entities.Concretes.EmailCode", "CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
